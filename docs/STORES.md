...
- Runtime control-plane and session-effectiveness receipts
  (`~/AIOS/logs/control-plane/`, `~/AIOS/logs/session-effectiveness/`) — local
  operator artifacts, ignored by git unless deliberately promoted elsewhere
