...
def test_plugin_manifest_points_to_cli_mcp_and_skill() -> None:
    plugin_dir = resources.files("repo_quality_certifier").joinpath("plugin")
    manifest_path = plugin_dir.joinpath("manifest.json")
    ...
    assert plugin_dir.joinpath("SKILL.md").is_file()
