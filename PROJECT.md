...
- workflow synthesis loop:
  ...
  - `bin/run-workflow-skill-experiments.py` runs queued workflow-skill experiments without an LLM agent, creates test-repo experiment branches, records baseline/candidate scores, and marks improvement outcomes
