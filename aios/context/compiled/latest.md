...
Give CrimClock access to the entire TMCP skill graph instead of only a namespace

## Task Classification

- Signals: all_tasks, task_touches_agent_harness, task_touches_permissions, task_touches_skill_registry
...
- `packets/workflow.approval-gates.md` (packets.workflow.approval-gates) — 2 applies_when signal(s) matched
...
- `packets/knowledge.notebooklm-routing.md` (packets.knowledge.notebooklm-routing) — 1 tag(s) matched
