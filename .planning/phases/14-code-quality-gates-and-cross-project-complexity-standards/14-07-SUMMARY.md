# Plan 14-07 Summary: BidCamp and tm Backfill Docs

## Outcome

Created complexity+simplification backfill inventories for the live repos:
...
- The tm docs were created outside the configured writable roots, so their directory/file writes required escalated filesystem access.
