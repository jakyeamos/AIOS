...
healthScore: 85
statusLabel: warning
nextStep: Migrate the remaining managed-runtime and session-ingestion adapters, close the restored-copy retention review, then freeze the paired effectiveness corpus before later execution.
blockers: []
